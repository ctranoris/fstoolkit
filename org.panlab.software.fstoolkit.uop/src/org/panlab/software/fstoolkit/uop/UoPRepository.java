...
public class UoPRepository implements IOfficeRepository {
	...
	public EList<Office> loadOffices() {
		// Get the resource
		String myUsername= Activator.getDefault().getPreferenceStore().getString( UoPOfficePreferenceConstants.P_UOPUSERNAME );
		String myPassw= Activator.getDefault().getPreferenceStore().getString( UoPOfficePreferenceConstants.P_UOPPASSWORD );
