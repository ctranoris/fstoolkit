...
public class ProvisionResource implements IProvisionResource {
	...
	public String provisionResource(String officeName, 
		...
		System.out.println(", PanlabOfficeProvider.getInstance()="+ Activator.getDefault().getResourceContext().toString() );
		System.out.println(", PanlabOfficeProvider.getInstance()="+ Activator.getDefault().getResourceContext().getOfficeModel().toString() );
