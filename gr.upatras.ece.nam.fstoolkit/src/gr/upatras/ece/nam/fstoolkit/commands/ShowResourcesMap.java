			...
			for (Object obj : strucSelection.toArray()) {
				...
				if (obj instanceof ui_TaxonomyTreeItem){
					if ( (((ui_TaxonomyTreeItem)obj).getBrokerElement() instanceof RequestedFederationScenario)   ){
						...
						String req="";
						RequestedFederationScenario scenario = (RequestedFederationScenario)((ui_TaxonomyTreeItem)obj).getBrokerElement();
						...
						try {
							...
							browser = support. createBrowser(IWorkbenchBrowserSupport.AS_VIEW, 
									((ui_TaxonomyTreeItem)obj).getBrokerElement().getName() +".webbrowser.fstoolkit", 
									"Map for "+((ui_TaxonomyTreeItem)obj).getBrokerElement().getName(), 
									"A world map for "+((ui_TaxonomyTreeItem)obj).getBrokerElement().getName());
