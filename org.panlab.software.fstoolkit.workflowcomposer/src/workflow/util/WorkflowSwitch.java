	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WorkflowPackage.ACTIVITY: {
				...
				if (result == null) result = caseworkflowElement(activity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkflowPackage.FORK: {
				...
				if (result == null) result = caseworkflowElement(fork);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkflowPackage.JOIN: {
				...
				if (result == null) result = caseworkflowElement(join);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case WorkflowPackage.FLOW: {
				Flow flow = (Flow)theEObject;
				T result = caseFlow(flow);
				if (result == null) result = caseworkflowElement(flow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
