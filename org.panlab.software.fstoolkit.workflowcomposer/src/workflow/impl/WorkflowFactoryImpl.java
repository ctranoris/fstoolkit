...
public class WorkflowFactoryImpl extends EFactoryImpl implements WorkflowFactory {
	...
	public static WorkflowFactory init() {
		try {
			WorkflowFactory theWorkflowFactory = (WorkflowFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.panlab.org/workflow"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case WorkflowPackage.FLOW: return createFlow();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case WorkflowPackage.TASK_STATUS:
				return createTASK_STATUSFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case WorkflowPackage.TASK_STATUS:
				return convertTASK_STATUSToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public TASK_STATUS createTASK_STATUSFromString(EDataType eDataType, String initialValue) {
		TASK_STATUS result = TASK_STATUS.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertTASK_STATUSToString(EDataType eDataType, Object instanceValue) {
