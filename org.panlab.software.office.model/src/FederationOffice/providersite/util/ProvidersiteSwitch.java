 ...
 * @generated
 */
public class ProvidersiteSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProvidersitePackage.PTM: {
				PTM ptm = (PTM)theEObject;
				T result = casePTM(ptm);
				if (result == null) result = caseNamedElement(ptm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProvidersitePackage.IGW: {
				IGW igw = (IGW)theEObject;
				T result = caseIGW(igw);
				if (result == null) result = caseNamedElement(igw);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProvidersitePackage.SITE: {
				...
				if (result == null) result = caseNamedElement(site);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProvidersitePackage.SITE_LOCATION: {
				SiteLocation siteLocation = (SiteLocation)theEObject;
				T result = caseSiteLocation(siteLocation);
				if (result == null) result = caseNamedElement(siteLocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>PTM</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>PTM</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePTM(PTM object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>IGW</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IGW</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIGW(IGW object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSiteLocation(SiteLocation object) {
		return null;
	}
