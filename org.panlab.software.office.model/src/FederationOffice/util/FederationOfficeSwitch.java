 ...
 * @generated
 */
public class FederationOfficeSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static FederationOfficePackage modelPackage;
	 ...
	 * @generated
	 */
	public FederationOfficeSwitch() {
		if (modelPackage == null) {
			modelPackage = FederationOfficePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FederationOfficePackage.OFFICE: {
				...
				if (result == null) result = caseNamedElement(office);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FederationOfficePackage.NAMED_ELEMENT: {
