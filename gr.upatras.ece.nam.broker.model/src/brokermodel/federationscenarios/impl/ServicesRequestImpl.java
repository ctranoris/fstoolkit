 ...
 * <ul>
 *   <li>{@link brokermodel.federationscenarios.impl.ServicesRequestImpl#getServiceRequestList <em>Service Request List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServicesRequestImpl extends NamedElementImpl implements ServicesRequest {
	...
	public EList<ServiceRequest> getServiceRequestList() {
		if (serviceRequestList == null) {
			serviceRequestList = new EObjectContainmentEList<ServiceRequest>(ServiceRequest.class, this, FederationscenariosPackage.SERVICES_REQUEST__SERVICE_REQUEST_LIST);
		}
