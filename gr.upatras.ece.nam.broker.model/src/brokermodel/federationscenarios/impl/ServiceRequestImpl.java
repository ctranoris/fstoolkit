 ...
 * <ul>
 *   <li>{@link brokermodel.federationscenarios.impl.ServiceRequestImpl#getRefService <em>Ref Service</em>}</li>
 *   <li>{@link brokermodel.federationscenarios.impl.ServiceRequestImpl#getOfferedByProviders <em>Offered By Providers</em>}</li>
 *   <li>{@link brokermodel.federationscenarios.impl.ServiceRequestImpl#getReqServiceSettings <em>Req Service Settings</em>}</li>
 *   <li>{@link brokermodel.federationscenarios.impl.ServiceRequestImpl#getNumOfServices <em>Num Of Services</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceRequestImpl extends NamedElementImpl implements ServiceRequest {
	...
	public EList<ServiceSettingInstance> getReqServiceSettings() {
		if (reqServiceSettings == null) {
			reqServiceSettings = new EObjectContainmentEList<ServiceSettingInstance>(ServiceSettingInstance.class, this, FederationscenariosPackage.SERVICE_REQUEST__REQ_SERVICE_SETTINGS);
		}
