 ...
 * <ul>
 *   <li>{@link brokermodel.federationscenarios.impl.ResourceRequestImpl#getRefOfferedResource <em>Ref Offered Resource</em>}</li>
 *   <li>{@link brokermodel.federationscenarios.impl.ResourceRequestImpl#getReqResourceSettings <em>Req Resource Settings</em>}</li>
 *   <li>{@link brokermodel.federationscenarios.impl.ResourceRequestImpl#getRuntimeInfo <em>Runtime Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceRequestImpl extends NamedElementImpl implements ResourceRequest {
	...
	public EList<ResourceSettingInstance> getReqResourceSettings() {
		if (reqResourceSettings == null) {
			reqResourceSettings = new EObjectContainmentEList<ResourceSettingInstance>(ResourceSettingInstance.class, this, FederationscenariosPackage.RESOURCE_REQUEST__REQ_RESOURCE_SETTINGS);
		}
