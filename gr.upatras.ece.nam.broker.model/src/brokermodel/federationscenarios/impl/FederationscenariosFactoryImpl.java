...
public class FederationscenariosFactoryImpl extends EFactoryImpl implements FederationscenariosFactory {
	...
	public static FederationscenariosFactory init() {
		try {
			FederationscenariosFactory theFederationscenariosFactory = (FederationscenariosFactory)EPackage.Registry.INSTANCE.getEFactory("http://nam.ece.upatras.gr/broker/model/federationscenarios"); 
