...
public class FederationscenariosPackageImpl extends EPackageImpl implements FederationscenariosPackage {
	...
	public void initializePackageContents() {
		...
		requestedFederationScenarioEClass.getESuperTypes().add(theBrokerPackage.getNamedElement());
		serviceRequestEClass.getESuperTypes().add(theBrokerPackage.getNamedElement());
		resourceRequestEClass.getESuperTypes().add(theBrokerPackage.getNamedElement());
		settingInstanceEClass.getESuperTypes().add(theBrokerPackage.getNamedElement());
		...
		credentialsEClass.getESuperTypes().add(theBrokerPackage.getNamedElement());
		servicesRequestEClass.getESuperTypes().add(theBrokerPackage.getNamedElement());
		infrastructureRequestEClass.getESuperTypes().add(theBrokerPackage.getNamedElement());
		resourceGroupEClass.getESuperTypes().add(theBrokerPackage.getNamedElement());
		...
		initEAttribute(getRequestedFederationScenario_Status(), theBrokerPackage.getScenarioStatus(), "status", null, 0, 1, RequestedFederationScenario.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
