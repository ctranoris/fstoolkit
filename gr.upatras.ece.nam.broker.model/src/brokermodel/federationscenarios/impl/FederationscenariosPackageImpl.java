...
public class FederationscenariosPackageImpl extends EPackageImpl implements FederationscenariosPackage {
	 ...
	 * @see brokermodel.federationscenarios.FederationscenariosPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		requestedFederationScenarioEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		serviceRequestEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		resourceRequestEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		settingInstanceEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		...
		credentialsEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		servicesRequestEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		infrastructureRequestEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		resourceGroupEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		...
		initEAttribute(getRequestedFederationScenario_Status(), theBrokermodelPackage.getScenarioStatus(), "status", null, 0, 1, RequestedFederationScenario.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
