 ...
 * <ul>
 *   <li>{@link brokermodel.uiObjects.impl.ui_TaxonomyTreeItemImpl#getParentNode <em>Parent Node</em>}</li>
 *   <li>{@link brokermodel.uiObjects.impl.ui_TaxonomyTreeItemImpl#getDisplayName <em>Display Name</em>}</li>
 *   <li>{@link brokermodel.uiObjects.impl.ui_TaxonomyTreeItemImpl#getChildNodes <em>Child Nodes</em>}</li>
 *   <li>{@link brokermodel.uiObjects.impl.ui_TaxonomyTreeItemImpl#getBrokerElement <em>Broker Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ui_TaxonomyTreeItemImpl extends EObjectImpl implements ui_TaxonomyTreeItem {
	...
	/**
	 * The cached value of the '{@link #getBrokerElement() <em>Broker Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected NamedElement brokerElement;
	...
	public EList<ui_TaxonomyTreeItem> getChildNodes() {
		if (childNodes == null) {
			childNodes = new EObjectContainmentEList<ui_TaxonomyTreeItem>(ui_TaxonomyTreeItem.class, this, UiObjectsPackage.UI_TAXONOMY_TREE_ITEM__CHILD_NODES);
		}
		return childNodes;
	}
	 ...
	 * @generated
	 */
	public NamedElement getBrokerElement() {
		if (brokerElement != null && brokerElement.eIsProxy()) {
			InternalEObject oldBrokerElement = (InternalEObject)brokerElement;
			brokerElement = (NamedElement)eResolveProxy(oldBrokerElement);
			if (brokerElement != oldBrokerElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UiObjectsPackage.UI_TAXONOMY_TREE_ITEM__BROKER_ELEMENT, oldBrokerElement, brokerElement));
			}
		}
	 ...
	 * @generated
	 */
	public NamedElement basicGetBrokerElement() {
		return brokerElement;
	}
	 ...
	 * @generated
	 */
	public void setBrokerElement(NamedElement newBrokerElement) {
		NamedElement oldBrokerElement = brokerElement;
		brokerElement = newBrokerElement;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiObjectsPackage.UI_TAXONOMY_TREE_ITEM__BROKER_ELEMENT, oldBrokerElement, brokerElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UiObjectsPackage.UI_TAXONOMY_TREE_ITEM__BROKER_ELEMENT:
				if (resolve) return getBrokerElement();
				return basicGetBrokerElement();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UiObjectsPackage.UI_TAXONOMY_TREE_ITEM__CHILD_NODES:
				...
				return;
			case UiObjectsPackage.UI_TAXONOMY_TREE_ITEM__BROKER_ELEMENT:
				setBrokerElement((NamedElement)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case UiObjectsPackage.UI_TAXONOMY_TREE_ITEM__CHILD_NODES:
				...
				return;
			case UiObjectsPackage.UI_TAXONOMY_TREE_ITEM__BROKER_ELEMENT:
				setBrokerElement((NamedElement)null);
				return;
		}
