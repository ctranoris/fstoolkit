...
public interface ResourcesPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int RESOURCE__NAME = BrokermodelPackage.NAMED_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int RESOURCE__ID = BrokermodelPackage.NAMED_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int RESOURCE__DESCRIPTION = BrokermodelPackage.NAMED_ELEMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int RESOURCE__UNIQUE_ID = BrokermodelPackage.NAMED_ELEMENT__UNIQUE_ID;
	 ...
	 * @ordered
	 */
	int RESOURCE__RESOURCE_SETTINGS = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESOURCE__CONTRIBUTES_TO_CATEGORIES = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESOURCE__REQUIRES_RESOURCES = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RESOURCE_FEATURE_COUNT = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int RESOURCE_CATEGORY__NAME = BrokermodelPackage.NAMED_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int RESOURCE_CATEGORY__ID = BrokermodelPackage.NAMED_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int RESOURCE_CATEGORY__DESCRIPTION = BrokermodelPackage.NAMED_ELEMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int RESOURCE_CATEGORY__UNIQUE_ID = BrokermodelPackage.NAMED_ELEMENT__UNIQUE_ID;
	 ...
	 * @ordered
	 */
	int RESOURCE_CATEGORY__RESOURCELIST = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESOURCE_CATEGORY_FEATURE_COUNT = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
