 ...
 * <!-- end-user-doc -->
 * @see brokermodel.resources.ResourcesPackage
 * @generated
 */
public class ResourcesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ResourcesPackage.OFFERED_RESOURCE: {
				OfferedResource offeredResource = (OfferedResource)theEObject;
				T result = caseOfferedResource(offeredResource);
				if (result == null) result = caseResource(offeredResource);
				if (result == null) result = caseNamedElement(offeredResource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcesPackage.RESOURCE_SETTING: {
				ResourceSetting resourceSetting = (ResourceSetting)theEObject;
				T result = caseResourceSetting(resourceSetting);
				if (result == null) result = caseAbstractSetting(resourceSetting);
				if (result == null) result = caseNamedElement(resourceSetting);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcesPackage.RESOURCE_CATEGORY: {
				...
				if (result == null) result = caseNamedElement(resourceCategory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Offered Resource</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Offered Resource</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOfferedResource(OfferedResource object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Resource Setting</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Resource Setting</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseResourceSetting(ResourceSetting object) {
		return null;
	}
