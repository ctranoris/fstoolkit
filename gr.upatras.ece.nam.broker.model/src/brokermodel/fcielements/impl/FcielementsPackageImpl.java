...
public class FcielementsPackageImpl extends EPackageImpl implements FcielementsPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getIFCIService_Broker(), theBrokerPackage.getBroker(), null, "broker", null, 0, 1, IFCIService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = addEOperation(ifciServiceEClass, theBrokerPackage.getBroker(), "getBroker", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(ifciServiceEClass, theBrokerPackage.getBroker(), "getBroker", 0, 1, IS_UNIQUE, IS_ORDERED);
