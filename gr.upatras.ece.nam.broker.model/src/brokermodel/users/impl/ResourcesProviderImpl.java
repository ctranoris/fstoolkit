 ...
 * <ul>
 *   <li>{@link brokermodel.users.impl.ResourcesProviderImpl#getOfferedSiteList <em>Offered Site List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ResourcesProviderImpl extends BrokerUserImpl implements ResourcesProvider {
	/**
	...
	public EList<Site> getOfferedSiteList() {
		if (offeredSiteList == null) {
			offeredSiteList = new EObjectContainmentWithInverseEList<Site>(Site.class, this, UsersPackage.RESOURCES_PROVIDER__OFFERED_SITE_LIST, ProvidersitePackage.SITE__BELONGS_TO_PROVIDER);
		}
