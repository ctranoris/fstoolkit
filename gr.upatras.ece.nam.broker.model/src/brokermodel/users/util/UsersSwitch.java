...
public class UsersSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case UsersPackage.RESOURCES_PROVIDER: {
				...
				if (result == null) result = caseBrokerUser(resourcesProvider);
			...
			case UsersPackage.TESTBED_DESIGNER: {
				...
				if (result == null) result = caseBrokerUser(testbedDesigner);
			...
			case UsersPackage.ADMIN: {
				...
				if (result == null) result = caseBrokerPersonel(admin);
				if (result == null) result = caseBrokerUser(admin);
				if (result == null) result = caseNamedElement(admin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UsersPackage.BROKER_CUSTOMER: {
				BrokerCustomer brokerCustomer = (BrokerCustomer)theEObject;
				T result = caseBrokerCustomer(brokerCustomer);
				if (result == null) result = caseBrokerUser(brokerCustomer);
				if (result == null) result = caseNamedElement(brokerCustomer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UsersPackage.BROKER_USER: {
				BrokerUser brokerUser = (BrokerUser)theEObject;
				T result = caseBrokerUser(brokerUser);
				if (result == null) result = caseNamedElement(brokerUser);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UsersPackage.BROKER_PERSONEL: {
				BrokerPersonel brokerPersonel = (BrokerPersonel)theEObject;
				T result = caseBrokerPersonel(brokerPersonel);
				if (result == null) result = caseBrokerUser(brokerPersonel);
				if (result == null) result = caseNamedElement(brokerPersonel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Broker Customer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Broker Customer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBrokerCustomer(BrokerCustomer object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Broker User</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Broker User</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBrokerUser(BrokerUser object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Broker Personel</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Broker Personel</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBrokerPersonel(BrokerPersonel object) {
		return null;
	}
