...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Scenario Status</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see brokermodel.BrokermodelPackage#getScenarioStatus()
 * @model
 * @generated
 */
public enum ScenarioStatus implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Scenario Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ScenarioStatus[] VALUES_ARRAY =
		new ScenarioStatus[] {
			NEW,
			REQUESTED,
	...
	/**
	 * A public read-only list of all the '<em><b>Scenario Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ScenarioStatus> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Scenario Status</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ScenarioStatus get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ScenarioStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Scenario Status</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ScenarioStatus getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ScenarioStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Scenario Status</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ScenarioStatus get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ScenarioStatus(int value, String name, String literal) {
		this.value = value;
		this.name = name;
