...
public class AvailabilityContractFactoryImpl extends EFactoryImpl implements AvailabilityContractFactory {
	...
	public static AvailabilityContractFactory init() {
		try {
			AvailabilityContractFactory theAvailabilityContractFactory = (AvailabilityContractFactory)EPackage.Registry.INSTANCE.getEFactory("http://nam.ece.upatras.gr/broker/model/availabilitycontract"); 
