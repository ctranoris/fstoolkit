/**
 */
package brokermodel.availabilityContract.impl;
...
import brokermodel.availabilityContract.RepatabilityScheme;
 ...
 * <ul>
 *   <li>{@link brokermodel.availabilityContract.impl.AvailabilityImpl#getFromTime <em>From Time</em>}</li>
 *   <li>{@link brokermodel.availabilityContract.impl.AvailabilityImpl#getToTime <em>To Time</em>}</li>
 *   <li>{@link brokermodel.availabilityContract.impl.AvailabilityImpl#getCost <em>Cost</em>}</li>
 *   <li>{@link brokermodel.availabilityContract.impl.AvailabilityImpl#getFromDate <em>From Date</em>}</li>
 *   <li>{@link brokermodel.availabilityContract.impl.AvailabilityImpl#getToDate <em>To Date</em>}</li>
 *   <li>{@link brokermodel.availabilityContract.impl.AvailabilityImpl#getRepeatability <em>Repeatability</em>}</li>
 *   <li>{@link brokermodel.availabilityContract.impl.AvailabilityImpl#isRepeat <em>Repeat</em>}</li>
 *   <li>{@link brokermodel.availabilityContract.impl.AvailabilityImpl#getRepeatUntil <em>Repeat Until</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
