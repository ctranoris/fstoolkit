...
public interface AvailabilityContractPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int RESOURCE_SERVICE_CONTRACT__NAME = BrokerPackage.NAMED_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int RESOURCE_SERVICE_CONTRACT__ID = BrokerPackage.NAMED_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int RESOURCE_SERVICE_CONTRACT__DESCRIPTION = BrokerPackage.NAMED_ELEMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int RESOURCE_SERVICE_CONTRACT__UNIQUE_ID = BrokerPackage.NAMED_ELEMENT__UNIQUE_ID;
	 ...
	 * @ordered
	 */
	int RESOURCE_SERVICE_CONTRACT__FOR_OFFERED_SERVICE = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESOURCE_SERVICE_CONTRACT__FOR_OFFERED_RESOURCE = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESOURCE_SERVICE_CONTRACT__START_DATE = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RESOURCE_SERVICE_CONTRACT__END_DATE = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int RESOURCE_SERVICE_CONTRACT__AVAILABILITY = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int RESOURCE_SERVICE_CONTRACT_FEATURE_COUNT = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 5;
