...
public class ExtensionInterfacesFactoryImpl extends EFactoryImpl implements ExtensionInterfacesFactory {
	...
	public static ExtensionInterfacesFactory init() {
		try {
			ExtensionInterfacesFactory theExtensionInterfacesFactory = (ExtensionInterfacesFactory)EPackage.Registry.INSTANCE.getEFactory("http://nam.ece.upatras.gr/broker/model/extensionInterfaces"); 
