...
public class ExtensionInterfacesPackageImpl extends EPackageImpl implements ExtensionInterfacesPackage {
	...
	public void initializePackageContents() {
		...
		addEOperation(iBrokerRepositoryEClass, theBrokerPackage.getBroker(), "loadBrokers", 0, -1, IS_UNIQUE, IS_ORDERED);

		addEOperation(iBrokerRepositoryEClass, theBrokerPackage.getBroker(), "getBrokers", 0, -1, IS_UNIQUE, IS_ORDERED);
