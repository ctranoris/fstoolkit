...
public class NetworkelementsFactoryImpl extends EFactoryImpl implements NetworkelementsFactory {
	...
	public static NetworkelementsFactory init() {
		try {
			NetworkelementsFactory theNetworkelementsFactory = (NetworkelementsFactory)EPackage.Registry.INSTANCE.getEFactory("http://nam.ece.upatras.gr/broker/model/networkelements"); 
