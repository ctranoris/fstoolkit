...
public interface NetworkelementsPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int NETWORK_ELEMENT__NAME = BrokermodelPackage.NAMED_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int NETWORK_ELEMENT__ID = BrokermodelPackage.NAMED_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int NETWORK_ELEMENT__DESCRIPTION = BrokermodelPackage.NAMED_ELEMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int NETWORK_ELEMENT__UNIQUE_ID = BrokermodelPackage.NAMED_ELEMENT__UNIQUE_ID;
	 ...
	 * @ordered
	 */
	int NETWORK_ELEMENT_FEATURE_COUNT = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
