...
public class ExperimentRuntimeFactoryImpl extends EFactoryImpl implements ExperimentRuntimeFactory {
	...
	public static ExperimentRuntimeFactory init() {
		try {
			ExperimentRuntimeFactory theExperimentRuntimeFactory = (ExperimentRuntimeFactory)EPackage.Registry.INSTANCE.getEFactory("http://nam.ece.upatras.gr/broker/model/experimentRuntime"); 
