...
public interface ExperimentRuntimePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int RUNTIME_ELEMENT__NAME = BrokerPackage.NAMED_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int RUNTIME_ELEMENT__ID = BrokerPackage.NAMED_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int RUNTIME_ELEMENT__DESCRIPTION = BrokerPackage.NAMED_ELEMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int RUNTIME_ELEMENT__UNIQUE_ID = BrokerPackage.NAMED_ELEMENT__UNIQUE_ID;
	 ...
	 * @ordered
	 */
	int RUNTIME_ELEMENT__STATUS = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RUNTIME_ELEMENT__GUID = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RUNTIME_ELEMENT__CONTEXT = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RUNTIME_ELEMENT_FEATURE_COUNT = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
