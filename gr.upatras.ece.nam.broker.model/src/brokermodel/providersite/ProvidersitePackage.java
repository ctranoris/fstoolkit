...
public interface ProvidersitePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int DOMAIN_MANAGER__NAME = BrokerPackage.NAMED_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int DOMAIN_MANAGER__ID = BrokerPackage.NAMED_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int DOMAIN_MANAGER__DESCRIPTION = BrokerPackage.NAMED_ELEMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int DOMAIN_MANAGER__UNIQUE_ID = BrokerPackage.NAMED_ELEMENT__UNIQUE_ID;
	 ...
	 * @ordered
	 */
	int DOMAIN_MANAGER__IP = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int DOMAIN_MANAGER__BELONGS_TO_SITE = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int DOMAIN_MANAGER_FEATURE_COUNT = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int SITE__NAME = BrokerPackage.NAMED_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int SITE__ID = BrokerPackage.NAMED_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int SITE__DESCRIPTION = BrokerPackage.NAMED_ELEMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int SITE__UNIQUE_ID = BrokerPackage.NAMED_ELEMENT__UNIQUE_ID;
	 ...
	 * @ordered
	 */
	int SITE__PTM = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SITE__LOCATED_AT = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SITE__OFFERED_RESOURCES_LIST = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int SITE__BELONGS_TO_PROVIDER = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int SITE_FEATURE_COUNT = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int SITE_LOCATION__NAME = BrokerPackage.NAMED_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int SITE_LOCATION__ID = BrokerPackage.NAMED_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int SITE_LOCATION__DESCRIPTION = BrokerPackage.NAMED_ELEMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int SITE_LOCATION__UNIQUE_ID = BrokerPackage.NAMED_ELEMENT__UNIQUE_ID;
	 ...
	 * @ordered
	 */
	int SITE_LOCATION__ADDRESS = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SITE_LOCATION__GEOCOORDS = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SITE_LOCATION_FEATURE_COUNT = BrokerPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;
