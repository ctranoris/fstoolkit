...
public class ProvidersitePackageImpl extends EPackageImpl implements ProvidersitePackage {
	...
	public void initializePackageContents() {
		...
		domainManagerEClass.getESuperTypes().add(theBrokerPackage.getNamedElement());
		siteEClass.getESuperTypes().add(theBrokerPackage.getNamedElement());
		siteLocationEClass.getESuperTypes().add(theBrokerPackage.getNamedElement());
