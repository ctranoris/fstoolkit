...
public class ServicesPackageImpl extends EPackageImpl implements ServicesPackage {
	...
	public void initializePackageContents() {
		...
		serviceEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		serviceSettingEClass.getESuperTypes().add(this.getAbstractSetting());
		offeredServiceEClass.getESuperTypes().add(this.getService());
		serviceCompositionEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		settingTypeEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		...
		taxonomyEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		abstractSettingEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		settingConstraintEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		...
		initEReference(getbrTypeList_ContainsElementsOf(), theBrokermodelPackage.getNamedElement(), null, "ContainsElementsOf", null, 0, 1, brTypeList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getbrTypeTideElement_OfTideElement(), theBrokermodelPackage.getNamedElement(), null, "ofTideElement", null, 0, 1, brTypeTideElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
