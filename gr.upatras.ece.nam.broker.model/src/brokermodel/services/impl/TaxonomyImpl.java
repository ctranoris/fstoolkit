 ...
 * <ul>
 *   <li>{@link brokermodel.services.impl.TaxonomyImpl#getTaxonomies <em>Taxonomies</em>}</li>
 *   <li>{@link brokermodel.services.impl.TaxonomyImpl#getCategories <em>Categories</em>}</li>
 *   <li>{@link brokermodel.services.impl.TaxonomyImpl#getHasScenarios <em>Has Scenarios</em>}</li>
 *   <li>{@link brokermodel.services.impl.TaxonomyImpl#getHasServices <em>Has Services</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaxonomyImpl extends NamedElementImpl implements Taxonomy {
	...
	public EList<Taxonomy> getTaxonomies() {
		if (taxonomies == null) {
			taxonomies = new EObjectContainmentEList<Taxonomy>(Taxonomy.class, this, ServicesPackage.TAXONOMY__TAXONOMIES);
		}
		return taxonomies;
	}
	...
	public EList<ResourceCategory> getCategories() {
		if (categories == null) {
			categories = new EObjectContainmentEList<ResourceCategory>(ResourceCategory.class, this, ServicesPackage.TAXONOMY__CATEGORIES);
		}
		return categories;
	}
