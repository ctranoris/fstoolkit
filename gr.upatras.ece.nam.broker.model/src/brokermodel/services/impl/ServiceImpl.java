 ...
 * <ul>
 *   <li>{@link brokermodel.services.impl.ServiceImpl#getServiceSettings <em>Service Settings</em>}</li>
 *   <li>{@link brokermodel.services.impl.ServiceImpl#getRequiresServices <em>Requires Services</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceImpl extends NamedElementImpl implements Service {
	...
	public EList<ServiceSetting> getServiceSettings() {
		if (serviceSettings == null) {
			serviceSettings = new EObjectContainmentEList<ServiceSetting>(ServiceSetting.class, this, ServicesPackage.SERVICE__SERVICE_SETTINGS);
		}
