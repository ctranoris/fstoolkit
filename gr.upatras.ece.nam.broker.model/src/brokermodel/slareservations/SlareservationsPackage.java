...
public interface SlareservationsPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SLA__NAME = BrokermodelPackage.NAMED_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int SLA__ID = BrokermodelPackage.NAMED_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int SLA__DESCRIPTION = BrokermodelPackage.NAMED_ELEMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int SLA__UNIQUE_ID = BrokermodelPackage.NAMED_ELEMENT__UNIQUE_ID;
	 ...
	 * @ordered
	 */
	int SLA__RESERVED_RSOURCES = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SLA__FOR_VT = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SLA__VALID_FROM = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int SLA__VALID_UNTIL = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int SLA_FEATURE_COUNT = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int RESERVED_RESOURCE_CONTRACT__NAME = BrokermodelPackage.NAMED_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int RESERVED_RESOURCE_CONTRACT__ID = BrokermodelPackage.NAMED_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int RESERVED_RESOURCE_CONTRACT__DESCRIPTION = BrokermodelPackage.NAMED_ELEMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int RESERVED_RESOURCE_CONTRACT__UNIQUE_ID = BrokermodelPackage.NAMED_ELEMENT__UNIQUE_ID;
	 ...
	 * @ordered
	 */
	int RESERVED_RESOURCE_CONTRACT__VALID_FROM = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESERVED_RESOURCE_CONTRACT__FOR_RESOURCE = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESERVED_RESOURCE_CONTRACT__VALID_UNTIL = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RESERVED_RESOURCE_CONTRACT_FEATURE_COUNT = BrokermodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
