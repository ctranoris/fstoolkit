...
public class SlareservationsFactoryImpl extends EFactoryImpl implements SlareservationsFactory {
	...
	public static SlareservationsFactory init() {
		try {
			SlareservationsFactory theSlareservationsFactory = (SlareservationsFactory)EPackage.Registry.INSTANCE.getEFactory("http://nam.ece.upatras.gr/broker/model/slareservations"); 
