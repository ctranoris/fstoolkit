 ...
 * <ul>
 *   <li>{@link brokermodel.slareservations.impl.SLAImpl#getReservedRsources <em>Reserved Rsources</em>}</li>
 *   <li>{@link brokermodel.slareservations.impl.SLAImpl#getForVT <em>For VT</em>}</li>
 *   <li>{@link brokermodel.slareservations.impl.SLAImpl#getValidFrom <em>Valid From</em>}</li>
 *   <li>{@link brokermodel.slareservations.impl.SLAImpl#getValidUntil <em>Valid Until</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SLAImpl extends NamedElementImpl implements SLA {
	...
	public EList<ReservedResourceContract> getReservedRsources() {
		if (reservedRsources == null) {
			reservedRsources = new EObjectContainmentEList<ReservedResourceContract>(ReservedResourceContract.class, this, SlareservationsPackage.SLA__RESERVED_RSOURCES);
		}
