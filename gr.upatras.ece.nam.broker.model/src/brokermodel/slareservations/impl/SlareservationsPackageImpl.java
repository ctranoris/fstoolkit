...
public class SlareservationsPackageImpl extends EPackageImpl implements SlareservationsPackage {
	...
	public void initializePackageContents() {
		...
		slaEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
		reservedResourceContractEClass.getESuperTypes().add(theBrokermodelPackage.getNamedElement());
