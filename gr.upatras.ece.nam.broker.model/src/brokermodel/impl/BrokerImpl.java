...
public class BrokerImpl extends NamedElementImpl implements Broker {
	...
	protected EClass eStaticClass() {
		return BrokerPackage.Literals.BROKER;
	}
	...
	public EList<BrokerUser> getRegisteredUsers() {
		if (registeredUsers == null) {
			registeredUsers = new EObjectContainmentEList<BrokerUser>(BrokerUser.class, this, BrokerPackage.BROKER__REGISTERED_USERS);
		}
	...
	public EList<Taxonomy> getContributedTaxonomies() {
		if (contributedTaxonomies == null) {
			contributedTaxonomies = new EObjectContainmentEList<Taxonomy>(Taxonomy.class, this, BrokerPackage.BROKER__CONTRIBUTED_TAXONOMIES);
		}
	...
	public EList<OfferedService> getOfferedServices() {
		if (offeredServices == null) {
			offeredServices = new EObjectContainmentEList<OfferedService>(OfferedService.class, this, BrokerPackage.BROKER__OFFERED_SERVICES);
		}
	...
	public EList<RequestedFederationScenario> getAvailableFederationScenarios() {
		if (availableFederationScenarios == null) {
			availableFederationScenarios = new EObjectContainmentEList<RequestedFederationScenario>(RequestedFederationScenario.class, this, BrokerPackage.BROKER__AVAILABLE_FEDERATION_SCENARIOS);
		}
	...
	public EList<ServiceComposition> getOfferedServiceCompositions() {
		if (offeredServiceCompositions == null) {
			offeredServiceCompositions = new EObjectContainmentEList<ServiceComposition>(ServiceComposition.class, this, BrokerPackage.BROKER__OFFERED_SERVICE_COMPOSITIONS);
		}
	...
	public EList<ResourceServiceContract> getResourceServiceContracts() {
		if (resourceServiceContracts == null) {
			resourceServiceContracts = new EObjectContainmentEList<ResourceServiceContract>(ResourceServiceContract.class, this, BrokerPackage.BROKER__RESOURCE_SERVICE_CONTRACTS);
		}
	...
	public EList<SLA> getSLAs() {
		if (slAs == null) {
			slAs = new EObjectContainmentEList<SLA>(SLA.class, this, BrokerPackage.BROKER__SL_AS);
		}
		return slAs;
	}
	...
	public void setResourceURI(String newResourceURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BrokerPackage.BROKER__RESOURCE_URI, oldResourceURI, resourceURI));
	}
	...
	public void setAPIGateway(String newAPIGateway) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BrokerPackage.BROKER__API_GATEWAY, oldAPIGateway, apiGateway));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BrokerPackage.BROKER__SL_AS:
				return getSLAs();
			case BrokerPackage.BROKER__RESOURCE_URI:
				return getResourceURI();
			case BrokerPackage.BROKER__API_GATEWAY:
