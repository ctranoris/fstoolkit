 ...
 * @generated
 */
public class BrokermodelPackageImpl extends EPackageImpl implements BrokermodelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see brokermodel.BrokermodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BrokermodelPackageImpl() {
		super(eNS_URI, BrokermodelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link BrokermodelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BrokermodelPackage init() {
		if (isInited) return (BrokermodelPackage)EPackage.Registry.INSTANCE.getEPackage(BrokermodelPackage.eNS_URI);

		// Obtain or create and register package
		BrokermodelPackageImpl theBrokermodelPackage = (BrokermodelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BrokermodelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BrokermodelPackageImpl());
		...
		theBrokermodelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(BrokermodelPackage.eNS_URI, theBrokermodelPackage);
		return theBrokermodelPackage;
	}
	 ...
	 * @generated
	 */
	public BrokermodelFactory getBrokermodelFactory() {
		return (BrokermodelFactory)getEFactoryInstance();
	}
