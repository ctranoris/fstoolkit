...
public class ResourceContext {
	...
	public ResourceContext(Office office) {
	...
	public Set<ServiceType> getAvailableServices() {
		...
		for (OfferedService service : office.getOfferedServices()) {
	...
	public Set<? extends ResourceProvider> getResourceProvidersForServiceType(
		...
		for (ResourceServiceContract contr : office.getResourceServiceContracts()) {
			if ( contr.getForOfferedService().getName().equals( elem.getName()  )  ){
				FederationOffice.users.ResourcesProvider officeprovider = contr.getForOfferedResource().getBelongsToSite().getBelongsToProvider();
	...
	* @param scenario The name of scenario where the Resource is involved
	...
	public void LoadFederationScenario(RequestedFederationScenario fedScenario) {
		FCI.getInstance().LoadFederationScenario(fedScenario, office);
