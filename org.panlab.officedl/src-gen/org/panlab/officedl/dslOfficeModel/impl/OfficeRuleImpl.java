 ...
 * <ul>
 *   <li>{@link org.panlab.officedl.dslOfficeModel.impl.OfficeRuleImpl#getImports <em>Imports</em>}</li>
 *   <li>{@link org.panlab.officedl.dslOfficeModel.impl.OfficeRuleImpl#getTestbedOfficev <em>Testbed Officev</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OfficeRuleImpl extends MinimalEObjectImpl.Container implements OfficeRule
{
  ...
  {
    return DslOfficeModelPackage.Literals.OFFICE_RULE;
  }
  ...
  public EList<ImportOffice> getImports()
  {
    if (imports == null)
    {
      imports = new EObjectContainmentEList<ImportOffice>(ImportOffice.class, this, DslOfficeModelPackage.OFFICE_RULE__IMPORTS);
    }
    return imports;
  }
  ...
  public NotificationChain basicSetTestbedOfficev(Office newTestbedOfficev, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DslOfficeModelPackage.OFFICE_RULE__TESTBED_OFFICEV, oldTestbedOfficev, newTestbedOfficev);
  ...
  public void setTestbedOfficev(Office newTestbedOfficev)
  {
    if (newTestbedOfficev != testbedOfficev)
    {
      ...
      if (testbedOfficev != null)
        msgs = ((InternalEObject)testbedOfficev).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DslOfficeModelPackage.OFFICE_RULE__TESTBED_OFFICEV, null, msgs);
      if (newTestbedOfficev != null)
        msgs = ((InternalEObject)newTestbedOfficev).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DslOfficeModelPackage.OFFICE_RULE__TESTBED_OFFICEV, null, msgs);
      msgs = basicSetTestbedOfficev(newTestbedOfficev, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslOfficeModelPackage.OFFICE_RULE__TESTBED_OFFICEV, newTestbedOfficev, newTestbedOfficev));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslOfficeModelPackage.OFFICE_RULE__IMPORTS:
        return ((InternalEList<?>)getImports()).basicRemove(otherEnd, msgs);
      case DslOfficeModelPackage.OFFICE_RULE__TESTBED_OFFICEV:
