...
import gr.upatras.ece.wcl.radl.AllowedType;
import gr.upatras.ece.wcl.radl.BindingParam;
import gr.upatras.ece.wcl.radl.Command;
import gr.upatras.ece.wcl.radl.ConfigurationParam;
import gr.upatras.ece.wcl.radl.Import;
import gr.upatras.ece.wcl.radl.ParameterType;
import gr.upatras.ece.wcl.radl.Protocol;
import gr.upatras.ece.wcl.radl.RadlFactory;
import gr.upatras.ece.wcl.radl.RadlPackage;
import gr.upatras.ece.wcl.radl.ResourceAdapter;
import gr.upatras.ece.wcl.radl.SupportedChildType;
import gr.upatras.ece.wcl.radl.assignCommand;
import gr.upatras.ece.wcl.radl.entryCommand;
import gr.upatras.ece.wcl.radl.rulJava_paraScript;
import gr.upatras.ece.wcl.radl.rulJava_param;
import gr.upatras.ece.wcl.radl.rulJava_paramInt;
import gr.upatras.ece.wcl.radl.rulJava_paramString;
import gr.upatras.ece.wcl.radl.rulSSH_commands;
import gr.upatras.ece.wcl.radl.ruleHTTP;
import gr.upatras.ece.wcl.radl.ruleHTTP_URL;
import gr.upatras.ece.wcl.radl.ruleJavaWrapper;
import gr.upatras.ece.wcl.radl.ruleSSH;
import gr.upatras.ece.wcl.radl.ruleXMLRPC;
...
public class RadlPackageImpl extends EPackageImpl implements RadlPackage
{
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  {
    return (EReference)resourceAdapterEClass.getEStructuralFeatures().get(7);
  }
   ...
   * @generated
   */
  public EReference getConfigurationParam_Servsetting()
  {
    return (EReference)configurationParamEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(configurationParamEClass, CONFIGURATION_PARAM__SERVSETTING);
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(radlEClass, gr.upatras.ece.wcl.radl.RADL.class, "RADL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getRADL_Imports(), this.getImport(), null, "imports", null, 0, 1, gr.upatras.ece.wcl.radl.RADL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRADL_ResourceAdapter(), this.getResourceAdapter(), null, "resourceAdapter", null, 0, 1, gr.upatras.ece.wcl.radl.RADL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getConfigurationParam_Servsetting(), theServicesPackage.getServiceSetting(), null, "servsetting", null, 0, 1, ConfigurationParam.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
