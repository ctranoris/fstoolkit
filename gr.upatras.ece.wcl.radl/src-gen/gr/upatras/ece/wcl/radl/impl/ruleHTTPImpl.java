 ...
 * <ul>
 *   <li>{@link gr.upatras.ece.wcl.radl.impl.ruleHTTPImpl#getRemoteMachine <em>Remote Machine</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.impl.ruleHTTPImpl#getHttpURL <em>Http URL</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.impl.ruleHTTPImpl#getHMethod <em>HMethod</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.impl.ruleHTTPImpl#getAuthMethod <em>Auth Method</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.impl.ruleHTTPImpl#getUsername <em>Username</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.impl.ruleHTTPImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.impl.ruleHTTPImpl#getPostBody <em>Post Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
