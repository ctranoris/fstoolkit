 ...
 * <ul>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleXMLRPC#getRemoteMachine <em>Remote Machine</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleXMLRPC#getUsername <em>Username</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleXMLRPC#getPassword <em>Password</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleXMLRPC#getRPCMethod <em>RPC Method</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleXMLRPC#getURLparams <em>UR Lparams</em>}</li>
 * </ul>
 * </p>
 *
 * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleXMLRPC()
 * @model
 * @generated
 */
public interface ruleXMLRPC extends Protocol
{
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleXMLRPC_RemoteMachine()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleXMLRPC#getRemoteMachine <em>Remote Machine</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleXMLRPC_Username()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleXMLRPC#getUsername <em>Username</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleXMLRPC_Password()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleXMLRPC#getPassword <em>Password</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleXMLRPC_RPCMethod()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleXMLRPC#getRPCMethod <em>RPC Method</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleXMLRPC_URLparams()
   * @model
   * @generated
   */
