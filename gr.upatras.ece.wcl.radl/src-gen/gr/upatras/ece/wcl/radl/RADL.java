 ...
 * <ul>
 *   <li>{@link gr.upatras.ece.wcl.radl.RADL#getImports <em>Imports</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.RADL#getResourceAdapter <em>Resource Adapter</em>}</li>
 * </ul>
 * </p>
 *
 * @see gr.upatras.ece.wcl.radl.RadlPackage#getRADL()
 * @model
 * @generated
 */
public interface RADL extends EObject
{
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getRADL_Imports()
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.RADL#getImports <em>Imports</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getRADL_ResourceAdapter()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.RADL#getResourceAdapter <em>Resource Adapter</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
