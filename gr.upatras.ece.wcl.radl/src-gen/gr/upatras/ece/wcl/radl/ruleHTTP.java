 ...
 * <ul>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleHTTP#getRemoteMachine <em>Remote Machine</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleHTTP#getHttpURL <em>Http URL</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleHTTP#getHMethod <em>HMethod</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleHTTP#getAuthMethod <em>Auth Method</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleHTTP#getUsername <em>Username</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleHTTP#getPassword <em>Password</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleHTTP#getPostBody <em>Post Body</em>}</li>
 * </ul>
 * </p>
 *
 * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleHTTP()
 * @model
 * @generated
 */
public interface ruleHTTP extends Protocol
{
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleHTTP_RemoteMachine()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleHTTP#getRemoteMachine <em>Remote Machine</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link gr.upatras.ece.wcl.radl.ruleHTTP_URL}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleHTTP_HttpURL()
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleHTTP_HMethod()
   * @model
   * @generated
   */
  String getHMethod();
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleHTTP#getHMethod <em>HMethod</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleHTTP_AuthMethod()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleHTTP#getAuthMethod <em>Auth Method</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleHTTP_Username()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleHTTP#getUsername <em>Username</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleHTTP_Password()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleHTTP#getPassword <em>Password</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleHTTP_PostBody()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleHTTP#getPostBody <em>Post Body</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
