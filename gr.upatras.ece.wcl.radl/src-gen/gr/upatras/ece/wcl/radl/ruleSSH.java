 ...
 * <ul>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleSSH#getRemoteMachine <em>Remote Machine</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleSSH#getRPort <em>RPort</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleSSH#getUsername <em>Username</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleSSH#getPassword <em>Password</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleSSH#getCommands <em>Commands</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleSSH#getCommandsDelete <em>Commands Delete</em>}</li>
 * </ul>
 * </p>
 *
 * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleSSH()
 * @model
 * @generated
 */
public interface ruleSSH extends Protocol
{
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleSSH_RemoteMachine()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleSSH#getRemoteMachine <em>Remote Machine</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleSSH_RPort()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleSSH#getRPort <em>RPort</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleSSH_Username()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleSSH#getUsername <em>Username</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleSSH_Password()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleSSH#getPassword <em>Password</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link gr.upatras.ece.wcl.radl.rulSSH_commands}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleSSH_Commands()
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleSSH_CommandsDelete()
   * @model containment="true"
   * @generated
   */
