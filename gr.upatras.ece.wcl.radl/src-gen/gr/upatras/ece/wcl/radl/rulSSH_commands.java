 ...
 * <ul>
 *   <li>{@link gr.upatras.ece.wcl.radl.rulSSH_commands#getRemoteCommand <em>Remote Command</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.rulSSH_commands#getScriptparams <em>Scriptparams</em>}</li>
 * </ul>
 * </p>
 *
 * @see gr.upatras.ece.wcl.radl.RadlPackage#getrulSSH_commands()
 * @model
 * @generated
 */
public interface rulSSH_commands extends EObject
{
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getrulSSH_commands_RemoteCommand()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.rulSSH_commands#getRemoteCommand <em>Remote Command</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link gr.upatras.ece.wcl.radl.scriptParam}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getrulSSH_commands_Scriptparams()
   * @model
   * @generated
   */
