 ...
 * <ul>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleHTTP_URL#getRemoteURL <em>Remote URL</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl.ruleHTTP_URL#getScriptparams <em>Scriptparams</em>}</li>
 * </ul>
 * </p>
 *
 * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleHTTP_URL()
 * @model
 * @generated
 */
public interface ruleHTTP_URL extends EObject
{
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleHTTP_URL_RemoteURL()
   * @model
   * @generated
   */
  String getRemoteURL();
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ruleHTTP_URL#getRemoteURL <em>Remote URL</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getruleHTTP_URL_Scriptparams()
   * @model
   * @generated
   */
