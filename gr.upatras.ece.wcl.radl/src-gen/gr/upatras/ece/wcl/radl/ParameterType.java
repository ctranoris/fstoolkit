 ...
 * <ul>
 *   <li>{@link gr.upatras.ece.wcl.radl.ParameterType#getPName <em>PName</em>}</li>
 * </ul>
 * </p>
 *
 * @see gr.upatras.ece.wcl.radl.RadlPackage#getParameterType()
 * @model
 * @generated
 */
public interface ParameterType extends EObject
{
   ...
   * @see #setPName(String)
   * @see gr.upatras.ece.wcl.radl.RadlPackage#getParameterType_PName()
   * @model
   * @generated
   */
  String getPName();
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl.ParameterType#getPName <em>PName</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
