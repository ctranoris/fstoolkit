...
//	}
	...
	"icons/full/obj16/Office.gif").createImage();
...
//	private static final Image IMAGE2= new Image(DISPLAY, DISPLAY.getSystemImage(SWT.ICON_ERROR).getImageData().scaledTo(IMAGE_SIZE, IMAGE_SIZE));
	...
	public  OfficeTaxonomiesLabelProvider(final Font boldFont) {
	...
	public void update(ViewerCell cell) {
		...
		else if ( (element instanceof ui_TaxonomyTreeItem) && (   ((ui_TaxonomyTreeItem)element).getOfficeElement() instanceof Taxonomy) ) {
			Taxonomy taxonomy= (Taxonomy) ((ui_TaxonomyTreeItem)element).getOfficeElement() ;
		...
		else if ( (element instanceof ui_TaxonomyTreeItem) && (   ((ui_TaxonomyTreeItem)element).getOfficeElement() instanceof ResourceCategory) ) {
			ResourceCategory serviceCategory= (ResourceCategory) ((ui_TaxonomyTreeItem)element).getOfficeElement() ;
		...
		}else if ( (element instanceof ui_TaxonomyTreeItem) && (   ((ui_TaxonomyTreeItem)element).getOfficeElement() instanceof Service) ) {
			Service service= (Service) ((ui_TaxonomyTreeItem)element).getOfficeElement() ;
		...
		}else if ( (element instanceof ui_TaxonomyTreeItem) && (   ((ui_TaxonomyTreeItem)element).getOfficeElement() instanceof Resource) ) {
			Resource service= (Resource) ((ui_TaxonomyTreeItem)element).getOfficeElement() ;
...
//				&& (   ((ui_TaxonomyTreeItem)element).getOfficeElement() instanceof RunningScenario) ) {
//			RunningScenario reqRunningScenario= (RunningScenario) ((ui_TaxonomyTreeItem)element).getOfficeElement() ;
//			
//			// Multi-font support only works in JFace 3.5 and above (specifically, 3.5 M4 and above).
//			// With JFace 3.4, the font information (bold in this example) will be ignored.
//			Styler style= StyledString.COUNTER_STYLER;
