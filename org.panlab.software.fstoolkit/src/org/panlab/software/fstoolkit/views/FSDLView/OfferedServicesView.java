...
public class OfferedServicesView extends ViewPart 
implements ITabbedPropertySheetPageContributor{ //we need this to display the selected item to the Tabbed property sheet editor
	 ...
	 */
	public static final String ID = "org.panlab.software.fstoolkit.views.OfferedServicesView";
...
//		viewer.setContentProvider( offProvider );
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				OfferedServicesView.this.fillContextMenu(manager);
			}
		});
	...
	public Object getAdapter(@SuppressWarnings("rawtypes") Class key) {     
		if (key.equals(IPropertySheetPage.class)) {			
			OfferedServicesTabbedPropertySheetPage tp = new OfferedServicesTabbedPropertySheetPage(this);			
			return  tp;
