...
import org.panlab.software.fstoolkit.providerAdapters.OfficeTaxonomiesContentProvider;
import org.panlab.software.fstoolkit.providerAdapters.OfficeTaxonomiesLabelProvider;
import org.panlab.software.fstoolkit.wizards.VCTImportWizard;
...
public class ScenariosView extends ViewPart{
	 ...
	 */
	public static final String ID = "org.panlab.software.fstoolkit.views.ScenariosView";
...
//		adapterFactory.addAdapterFactory(new myServicesItemProviderAdapterFactory());
		...
		OfficeTaxonomiesContentProvider vctsProvider = new OfficeTaxonomiesContentProvider( getViewSite(), false, false, true);
		vctsProvider.AddOfficesFromManager( Activator.getDefault().getOfficeManager() );
	...
	private void makeActions() {
		...
		importVCTAction = new Action() {
			public void run() {
				...
				if (!(obj instanceof FederationOffice.federationscenarios.RequestedFederationScenario  ))
					return;

				System.out.println("============ RequestedFederationScenario: "+ obj.toString() );
				
//				PanlabServices.getInstance().LoadFSbyVCT( 
//						(FederationOffice.federationscenarios.RequestedFederationScenario)obj);
		...
		importVCTAction.setToolTipText("Import selected VCT from panlab Office as FSDL definition");
