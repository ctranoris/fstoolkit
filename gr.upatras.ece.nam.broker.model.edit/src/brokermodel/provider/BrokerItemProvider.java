...
public class BrokerItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BrokerPackage.Literals.BROKER__RESOURCE_URI,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BrokerPackage.Literals.BROKER__API_GATEWAY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BrokerPackage.Literals.BROKER__REGISTERED_USERS);
			childrenFeatures.add(BrokerPackage.Literals.BROKER__CONTRIBUTED_TAXONOMIES);
			childrenFeatures.add(BrokerPackage.Literals.BROKER__OFFERED_SERVICES);
			childrenFeatures.add(BrokerPackage.Literals.BROKER__AVAILABLE_FEDERATION_SCENARIOS);
			childrenFeatures.add(BrokerPackage.Literals.BROKER__OFFERED_SERVICE_COMPOSITIONS);
			childrenFeatures.add(BrokerPackage.Literals.BROKER__RESOURCE_SERVICE_CONTRACTS);
			childrenFeatures.add(BrokerPackage.Literals.BROKER__SL_AS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BrokerPackage.Literals.BROKER__REGISTERED_USERS,
		...
		newChildDescriptors.add
			(createChildParameter
				(BrokerPackage.Literals.BROKER__CONTRIBUTED_TAXONOMIES,
				 ServicesFactory.eINSTANCE.createTaxonomy()));

		newChildDescriptors.add
			(createChildParameter
				(BrokerPackage.Literals.BROKER__OFFERED_SERVICES,
				 ServicesFactory.eINSTANCE.createOfferedService()));

		newChildDescriptors.add
			(createChildParameter
				(BrokerPackage.Literals.BROKER__AVAILABLE_FEDERATION_SCENARIOS,
				 FederationscenariosFactory.eINSTANCE.createRequestedFederationScenario()));

		newChildDescriptors.add
			(createChildParameter
				(BrokerPackage.Literals.BROKER__OFFERED_SERVICE_COMPOSITIONS,
				 ServicesFactory.eINSTANCE.createServiceComposition()));

		newChildDescriptors.add
			(createChildParameter
				(BrokerPackage.Literals.BROKER__RESOURCE_SERVICE_CONTRACTS,
				 AvailabilityContractFactory.eINSTANCE.createResourceServiceContract()));

		newChildDescriptors.add
			(createChildParameter
				(BrokerPackage.Literals.BROKER__SL_AS,
