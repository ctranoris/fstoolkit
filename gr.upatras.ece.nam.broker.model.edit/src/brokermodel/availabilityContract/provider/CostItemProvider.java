...
/**
 * This is the item provider adapter for a {@link brokermodel.availabilityContract.Cost} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CostItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPerUnitPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Per Unit feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPerUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cost_perUnit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cost_perUnit_feature", "_UI_Cost_type"),
				 AvailabilityContractPackage.Literals.COST__PER_UNIT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AvailabilityContractPackage.Literals.COST__AMOUNT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		costUnit labelValue = ((Cost)object).getPerUnit();
