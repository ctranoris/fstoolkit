...
public class SDLStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new gr.upatras.ece.wcl.SDLRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://wcl.ece.upatras.gr/SDL")) {
		EPackage.Registry.INSTANCE.put("http://wcl.ece.upatras.gr/SDL", gr.upatras.ece.wcl.officeSDL.OfficeSDLPackage.eINSTANCE);
	}
