...
public class OfficeDLStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.panlab.software.officedl2.OfficeDLRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.panlab.org/software/officedl2/OfficeDL")) {
		EPackage.Registry.INSTANCE.put("http://www.panlab.org/software/officedl2/OfficeDL", org.panlab.software.officedl2.officeDL.OfficeDLPackage.eINSTANCE);
	}
