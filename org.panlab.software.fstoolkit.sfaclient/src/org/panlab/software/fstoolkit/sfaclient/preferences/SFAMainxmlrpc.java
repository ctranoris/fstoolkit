...
//	private static String SFAversion ="1" ;//= "";
//	private static String SFAtype ="SFA";
//			
//	public static Object XXXtestMe(String regurl, String smurl, String kstore,
...
//
//
//	private static Object ListResources() {
//
//		System.out.println("ListResources()");
//		Object result;
//		Vector<Serializable> params = new Vector<Serializable>();
...
//		// auth.put("version", "2");
//
//		auth.put("version", SFAversion);
//		auth.put("type", SFAtype);
//		// java.util.List<String> extensions = new
