...
/**
 * This is the item provider adapter for a {@link FederationOffice.services.AbstractSetting} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		newChildDescriptors.add
			(createChildParameter
				(ServicesPackage.Literals.ABSTRACT_SETTING__SETTING_TYPE,
				 ServicesFactory.eINSTANCE.createtideTypeString()));

		newChildDescriptors.add
			(createChildParameter
				(ServicesPackage.Literals.ABSTRACT_SETTING__SETTING_TYPE,
				 ServicesFactory.eINSTANCE.createtideTypeEnum()));

		newChildDescriptors.add
			(createChildParameter
				(ServicesPackage.Literals.ABSTRACT_SETTING__SETTING_TYPE,
				 ServicesFactory.eINSTANCE.createtideTypeList()));

		newChildDescriptors.add
			(createChildParameter
				(ServicesPackage.Literals.ABSTRACT_SETTING__SETTING_TYPE,
				 ServicesFactory.eINSTANCE.createtideTypeTideElement()));
