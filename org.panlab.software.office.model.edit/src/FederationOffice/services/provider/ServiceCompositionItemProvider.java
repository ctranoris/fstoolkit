...
/**
 * This is the item provider adapter for a {@link FederationOffice.services.ServiceComposition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceCompositionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceComposition_hasServices_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceComposition_hasServices_feature", "_UI_ServiceComposition_type"),
				 ServicesPackage.Literals.SERVICE_COMPOSITION__HAS_SERVICES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((ServiceComposition)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ServiceComposition_type") :
			getString("_UI_ServiceComposition_type") + " " + label;
	}
