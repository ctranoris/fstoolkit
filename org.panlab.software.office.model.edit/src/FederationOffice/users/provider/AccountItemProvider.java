...
/**
 * This is the item provider adapter for a {@link FederationOffice.users.Account} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AccountItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsersPackage.Literals.ACCOUNT__PASSWORD,
				 true,
				 false,
				 false,
	...
	protected void addUsernamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Account_username_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Account_username_feature", "_UI_Account_type"),
				 UsersPackage.Literals.ACCOUNT__USERNAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UsersPackage.Literals.ACCOUNT__AUTHORIZATION_KEY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UsersPackage.Literals.ACCOUNT__AUTHORIZATION_KEY,
				 FcielementsFactory.eINSTANCE.createAuthorizationKey()));
	}
