...
/**
 * This is the item provider adapter for a {@link FederationOffice.providersite.Site} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SiteItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProvidersitePackage.Literals.SITE__IGWLIST);
		...
		newChildDescriptors.add
			(createChildParameter
				(ProvidersitePackage.Literals.SITE__PTM,
				 ProvidersiteFactory.eINSTANCE.createPTM()));

		newChildDescriptors.add
			(createChildParameter
				(ProvidersitePackage.Literals.SITE__IGWLIST,
				 ProvidersiteFactory.eINSTANCE.createIGW()));

		newChildDescriptors.add
			(createChildParameter
				(ProvidersitePackage.Literals.SITE__LOCATED_AT,
				 ProvidersiteFactory.eINSTANCE.createSiteLocation()));

		newChildDescriptors.add
			(createChildParameter
				(ProvidersitePackage.Literals.SITE__OFFERED_RESOURCES_LIST,
				 ResourcesFactory.eINSTANCE.createOfferedResource()));
	}
