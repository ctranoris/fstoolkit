...
//			System::out.println( "compile reqResource=" + reqResource.name)
//			if (reqResource.refOfferedResource == null ){
//				System::out.println( "compile reqResource.ref = null!!" )				
//			}
//			reqResource.refOfferedResource.toClass(fsa);	
//		}
		System::out.println( "compile4=" +e.name)
...
//				// Update assignments for resources of group
	...
	def dispatch toClass(OfferedResource m, IFileSystemAccess fsa) {
