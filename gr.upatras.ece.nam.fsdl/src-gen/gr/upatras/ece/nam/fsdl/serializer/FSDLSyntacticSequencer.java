...
public class FSDLSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected void init(IGrammarAccess access) {
		...
		match_ServiceRequest_OptionalKeyword_6_2_q = new TokenAlias(false, true, grammarAccess.getServiceRequestAccess().getOptionalKeyword_6_2());
