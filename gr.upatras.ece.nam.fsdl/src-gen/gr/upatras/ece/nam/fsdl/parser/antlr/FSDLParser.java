...
public class FSDLParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected gr.upatras.ece.nam.fsdl.parser.antlr.internal.InternalFSDLParser createParser(XtextTokenStream stream) {
		return new gr.upatras.ece.nam.fsdl.parser.antlr.internal.InternalFSDLParser(stream, getGrammarAccess());
	}
