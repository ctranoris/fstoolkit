 ...
 * <ul>
 *   <li>{@link gr.upatras.ece.wcl.radl2.radl.scriptParam#getParamType <em>Param Type</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl2.radl.scriptParam#getName <em>Name</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl2.radl.scriptParam#getDefValue <em>Def Value</em>}</li>
 *   <li>{@link gr.upatras.ece.wcl.radl2.radl.scriptParam#getDescriptionValue <em>Description Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see gr.upatras.ece.wcl.radl2.radl.RadlPackage#getscriptParam()
 * @model
 * @generated
 */
public interface scriptParam extends EObject
{
   ...
   * @see gr.upatras.ece.wcl.radl2.radl.RadlPackage#getscriptParam_ParamType()
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl2.radl.scriptParam#getParamType <em>Param Type</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see gr.upatras.ece.wcl.radl2.radl.RadlPackage#getscriptParam_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl2.radl.scriptParam#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl2.radl.RadlPackage#getscriptParam_DefValue()
   * @model
   * @generated
   */
  String getDefValue();
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl2.radl.scriptParam#getDefValue <em>Def Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gr.upatras.ece.wcl.radl2.radl.RadlPackage#getscriptParam_DescriptionValue()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gr.upatras.ece.wcl.radl2.radl.scriptParam#getDescriptionValue <em>Description Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
