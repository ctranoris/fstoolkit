...
public abstract class AbstractRadlSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected void init(IGrammarAccess access) {
		...
		match_ruleXMLRPC___ParametersKeyword_12_0_EqualsSignKeyword_12_1__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getRuleXMLRPCAccess().getParametersKeyword_12_0()), new TokenAlias(false, false, grammarAccess.getRuleXMLRPCAccess().getEqualsSignKeyword_12_1()));
	}
