...
public class RadlStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new gr.upatras.ece.wcl.radl2.RadlRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.upatras.gr/ece/wcl/radl2/Radl")) {
		EPackage.Registry.INSTANCE.put("http://www.upatras.gr/ece/wcl/radl2/Radl", gr.upatras.ece.wcl.radl2.radl.RadlPackage.eINSTANCE);
	}
