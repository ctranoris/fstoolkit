...
//	private static String authority = "plc.uoppldef.tranoris";
	...
	private static String keystore = "C:\\Users\\ctranoris\\Desktop\\_downloads\\tmp\\plckeys\\sfa1inriactranoris_2.p12";
	private static String authority = "firexp.openlab.ctranoris";;//private static String authority = "pla.openlab.ctranoris";
...
//				"-----END CERTIFICATE-----") );
		...
		//the following for SFA_INRIA, pla.openlab.ctranoris
//		params.addElement( new String("-----BEGIN CERTIFICATE-----\n"+
...
//"-----END CERTIFICATE-----" ));
		...
		//the following for SFA_INRIA, openlab.ctranoris
		params.addElement( new String("-----BEGIN CERTIFICATE-----\n"+
				"MIIC8DCCAdgCCQCe2AdX9shsljANBgkqhkiG9w0BAQUFADA6MQswCQYDVQQGEwJH\n"+
				"UjEPMA0GA1UECAwGQWNoYWlhMRowGAYDVQQDDBFvcGVubGFiLmN0cmFub3JpczAe\n"+
				"Fw0xMjA1MzAwOTQxNTJaFw0xNzA1MjkwOTQxNTJaMDoxCzAJBgNVBAYTAkdSMQ8w\n"+
				"DQYDVQQIDAZBY2hhaWExGjAYBgNVBAMMEW9wZW5sYWIuY3RyYW5vcmlzMIIBIjAN\n"+
				"BgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAsSvxbmgfl47s2xhPwLObNMhJ/qZK\n"+
				"9lBbA1kv+R1yGdKoDRwRTIGMVOFe+ahaI2Ul3T+SpNOyRKGtisMupO12RiFurLm+\n"+
				"g/k979hTp8vfMoDep1HxFkSPEFeDjK6QTbTNbYFKJmo2DIadJR70NqTgb9bt67B4\n"+
				"D8oC3BrcmHjbDQJEaX8+uV6moplI/26Krux1wZesi9SCD/bMHRYrxoaGVmBpaT6Y\n"+
				"7zJoGjk5BUZVwlBSxP1iPRTA12a2piQd+xDGOJBuqmLnShGrEH2vEqotZ4ZRKeC/\n"+
				"XAqZiOG9AuqMX/aVnFTTWQ8wxQevwDO2ocCqsz5h+DL8QdBBCayab12FfwIDAQAB\n"+
				"MA0GCSqGSIb3DQEBBQUAA4IBAQAGlmyI/6boRmzw52FDKbw0+YT28GEMWlwDZz2p\n"+
				"n2Njsao2a47QqOjxF0JZvY90cDdaPf75w92RndgyDKJHP+9BR34Uu1rBFrkHq3zH\n"+
				"T36/FkgAxW8ZemTRbPBIZAnzjBt+uj7Pq6IrGFHjUXGbKhUvw8c07IVY515It/65\n"+
				"XGO+XexC0zwTh+3CTmEGhsRan/588B/CX++3pAyuL8E3vwCXPZlmmYgek5W3TQOx\n"+
				"SBjdrMfMt8soKyIWVAKAAWeDm83dbQ3TEifbUhq/OYZOPvxPyVPUWntUAOwkaBxd\n"+
				"YleuSi8DznG6l/i96HrndLP+vsum4N/4/wV6hxRi9WF5xZfy\n"+
"-----END CERTIFICATE-----" ));
