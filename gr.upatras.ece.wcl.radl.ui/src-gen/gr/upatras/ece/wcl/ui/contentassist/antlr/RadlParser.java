...
public class RadlParser extends AbstractContentAssistParser {
	...
	@Override
	protected gr.upatras.ece.wcl.ui.contentassist.antlr.internal.InternalRadlParser createParser() {
		gr.upatras.ece.wcl.ui.contentassist.antlr.internal.InternalRadlParser result = new gr.upatras.ece.wcl.ui.contentassist.antlr.internal.InternalRadlParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConfigurationParamAccess().getGroup_5(), "rule__ConfigurationParam__Group_5__0");
					...
					put(grammarAccess.getConfigurationParamAccess().getServsettingAssignment_4_1(), "rule__ConfigurationParam__ServsettingAssignment_4_1");
					put(grammarAccess.getConfigurationParamAccess().getDescriptionValueAssignment_5_2(), "rule__ConfigurationParam__DescriptionValueAssignment_5_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			gr.upatras.ece.wcl.ui.contentassist.antlr.internal.InternalRadlParser typedParser = (gr.upatras.ece.wcl.ui.contentassist.antlr.internal.InternalRadlParser) parser;
